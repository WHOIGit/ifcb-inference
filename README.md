...
pip install "ifcb-infer[cuda,torch,parquet] @ git+https://github.com/WHOIGit/ifcb-inference.git" --extra-index-url https://download.pytorch.org/whl/cpu
...
pip install -e ".[cuda,torch,parquet,dev]" --extra-index-url https://download.pytorch.org/whl/cpu
```
